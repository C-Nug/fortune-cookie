...
class MainHandler(webapp2.RequestHandler):
    def get(self):      #needs to be called "get"
        ...
        cookie_refresh_button = "<a href='.'><button>Another cookie plz!</button></a>"

        content = header + fortune_paragraph + number_paragraph + cookie_refresh_button
